...
function seedBankData(bankId) {
    ...
    const account1Id = (0, uuid_1.v4)();
    const account2Id = (0, uuid_1.v4)();
    const account3Id = (0, uuid_1.v4)();
    // John's checking account
    db.accounts.set(account1Id, {
        id: account1Id,
        customerId: customer1Id,
        bankId,
        accountType: common_1.AccountType.CURRENT,
    ...
    db.accounts.set(account2Id, {
        ...
        customerId: customer1Id,
        bankId,
        accountType: common_1.AccountType.SAVINGS,
    ...
    const dbService = new database_service_1.DatabaseService(bankId);
    const banks = [
    ...
    for (const bank of banks) {
        try {
            ...
            console.error(`Error adding bank ${bank.id}: ${error.message}`);
        }
    }
}
exports.seedBankData = seedBankData;
